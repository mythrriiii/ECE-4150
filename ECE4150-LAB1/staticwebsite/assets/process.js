const API_URL = "https://gugthjaexj.execute-api.us-east-1.amazonaws.com/dev";
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-muralikannan-2024-4150";
...
function updatePhoto(PhotoID,CreationTime){
    checkIfLoggedIn();
    var title = $("#title").val();
    var description = $("#description").val();
    var tags = $("#tags").val();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            location.href = 'index.html';//makes browser the viewphoto page
        },
        error: function() {
...
function deletePhoto(PhotoID, CreationTime) {
    checkIfLoggedIn();
    ...
    console.log(datadir);
    console.log(JSON.stringify(datadir));
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            console.log('Success!')
            //redirect user to homepage
            location.href = 'index.html';//makes browser the home page
        },
        error: function() {
...
$('#portfolio-4-col-grid').on('click', '#home_delete', function(e) {
    ...
    deletePhoto($this.data('photoid'), $this.data('creationtime'));
})

$('#viewphoto-container').on('click', '#photo_update', function(e) {
     var $this = $(this);
     console.log("UPDATING!!");
     updatePhoto($this.data('photo'),$this.data('photo'));
 });
 ...
 $('#viewphoto-container').on('click', '#photo_delete', function() {
     ...
     deletePhoto($this.data('photo'), $this.data('photo'));
 });
